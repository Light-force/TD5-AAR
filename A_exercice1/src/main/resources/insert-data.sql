...
insert into PROJET(CODEPROJET,NOMPROJET,STATUT) values ('NAPOLEON','Soldat','TERMINE')
...
insert into ADRESSE(IDADRESSE,RUE,CODEPOSTAL,VILLE,CODEPAYS) values (2,'Collecteur de la Bièvre',75013,'PARIS','FR');
insert into EMPLOYES(IDEMP,NOMEMP,PRENOMEMP,IDADRESSE,IDMACHINE) values (1,'Valjean','Jean',1,1),(5,'Thénardier','Maître',2,2),;
insert into EMPLOYES(IDEMP,NOMEMP,PRENOMEMP) values (2,'Javert','Inspecteur'),(3,'Thénardier','Eponine'),(4,'Thénardier','Alzema'),(6,'Thénardier','Madame'), (7,'Le Surineur','Jeannot');
...
insert into PROJETSTERMINES(IDEMP,CODEPROJET) values(5,'NAPOLEON');

insert into TELEPHONEDE(IDEMP,IDTEL) values (2,1),(1,2),(5,3);